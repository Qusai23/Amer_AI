...
class MultiagentState:
    ...
    def __init__(self, p, robots, g, actions):
        ...
        dx_1 = abs(robots[0].position_x - robots[0].goal_x)
        dy_1 = abs(robots[0].position_y - robots[0].goal_y)
        dx_2 = abs(robots[1].position_x - robots[1].goal_x)
        dy_2 = abs(robots[1].position_y - robots[1].goal_y)

        if dx_1 != 0 and dy_1 !=0 or dx_2 != 0 and dx_2 != 0:
            self.h = (dx_1+dy_1) + (dx_2+dy_2) + 6
        else:
            self.h = (dx_1+dy_1) + (dx_2+dy_2)
